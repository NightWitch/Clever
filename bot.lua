...
local msgadd = redis:get("botBOT-IDaddmsg") and "🌕" or "🌑"
     ...
     local txtadd = redis:get("botBOT-IDaddmsgtext") or  "ادت کردم عشقم پیوی نقطه بذار😋"
